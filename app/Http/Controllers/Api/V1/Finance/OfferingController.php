...
class OfferingController extends BaseApiController implements HasMiddleware
{
    /**
    ...
    {
        return [
            new Middleware('permission:finance.view',   only: ['index', 'show', 'summary']),
            new Middleware('permission:finance.create', only: ['store', 'import']),
